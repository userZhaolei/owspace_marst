package com.tk.owspace_marst.util.tool;
...
import com.tk.owspace_marst.util.PaintViewUtil;
...
//        Logger.e("paramDocument="+paramDocument);
        ...
        Iterator localIterator = paramDocument.getAllElements().iterator(); //遍历所有的标签
        while (localIterator.hasNext()) {
            Element localElement = (Element) localIterator.next();  //标签
